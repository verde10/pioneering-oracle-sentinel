;; oracle-sentinel-registry
;; This contract manages the registration, verification, and monitoring of oracle data sources
;; on the Stacks blockchain. It provides a comprehensive system for tracking oracle reliability,
;; registering data providers, and maintaining a trustless oracle verification mechanism.
;; The contract facilitates secure and transparent oracle data validation.
;; Error Constants
